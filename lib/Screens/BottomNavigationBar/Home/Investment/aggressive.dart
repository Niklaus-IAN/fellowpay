...
class AggressiveRisk extends StatefulWidget {
  const AggressiveRisk({super.key});

  @override
  State<AggressiveRisk> createState() => _AggressiveRiskState();
}

class _AggressiveRiskState extends State<AggressiveRisk> {
  @override
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage(
                          'assets/images/Aggressive.png'), // Replace with your image path
                      fit: BoxFit
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Best time to invest in Aggressive stocks',
                        style: TextStyle(
                          fontSize: 14,
