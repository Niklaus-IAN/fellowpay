import 'package:fellowpay/Screens/BottomNavigationBar/Escrow/transfertobank.dart';
...
class _SendMoneyScreenState extends State<SendMoneyScreen> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    Text(
                      'NGN',
                      style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: blue
                      ),
                    ),
                    SizedBox(width: 10),
                    Expanded(
              ...
              Row(
                children: [
                  _beneficiaryItem(icon: Icons.add, label: 'Add', onTap: (){
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => TransferToBank(), // Directly navigating to TransferScreen
                      ),
                    );
                  }),
                  SizedBox(width: 10),
              ...
              SizedBox(
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: (){}, child: Text('Send Money',style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w600),)))
            ],
          ),
        ),
      ),
  ...
  Widget _beneficiaryItem({IconData? icon, String? imagePath, required String label, void Function()? onTap}) {
