...
class ModerateRisk extends StatefulWidget {
  const ModerateRisk({super.key});

  @override
  State<ModerateRisk> createState() => _ModerateRiskState();
}

class _ModerateRiskState extends State<ModerateRisk> {
  @override
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage(
                          'assets/images/Moderate.png'), // Replace with your image path
                      fit: BoxFit
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Best time to invest in Moderate stocks',
                        style: TextStyle(
                          fontSize: 14,
